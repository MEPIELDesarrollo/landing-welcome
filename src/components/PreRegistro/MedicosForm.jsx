...
// ─── Main component ────────────────────────────────────────────────────────────
export default function MedicosForm({ onStepChange }) {
  ...
  const [step2Data, setStep2Data] = useState({
    cfdi: '', ine: null, compDom: null, constancia: null,
  });
  ...
  const handleFormSubmit = async (e) => {
    ...
    if (step === 2) {
      ...
      try {
        ...
        const datosUnificados = { ...step1Data, cfdi: step2Data.cfdi, tipoForm: "MEDICOS" };
